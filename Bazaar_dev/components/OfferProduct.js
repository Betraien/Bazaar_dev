  ...
  render() {
    ...
    return (
      <Block row={horizontal} card flex style={[styles.product, styles.shadow, style]}>
        <TouchableWithoutFeedback onPress={() => navigation.navigate('OfferProduct', { product: product })}>
        ...
        <Text color={theme.COLORS.MUTED} size={12}>
            ...
            <Text size={12} muted={!priceColor} color={priceColor}>{product.price} ر.س</Text>
            </Block>
            ...
            <Ionicons name="ios-add" size={30} color="crimson" onPress={() => navigation.navigate('OfferProduct')}/>
        
        </Block>
            <Block style={{flex: 1, flexDirection: 'row'}}>
            <Ionicons name="ios-more" size={30} color="gray" onPress={() => navigation.navigate('Offer')}/>
            </Block>
        </Block>
...
export default withNavigation(OfferProduct);
