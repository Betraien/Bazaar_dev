...
import { Icon, ServiceProduct } from '../components/';
  ...
  renderProducts = () => {
    return (
      <ScrollView
        ...
        <Block flex>
          <ServiceProduct product={homeImages[0]} full />
            <ServiceProduct product={homeImages[1]} full />
            <ServiceProduct product={homeImages[2]} full />
